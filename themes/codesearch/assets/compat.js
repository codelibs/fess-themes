...
/*
 * codesearch theme — Bootstrap JavaScript compatibility shim.
 *
 * The codesearch theme ships no Bootstrap/Popper. The SPA modules (app.js,
...
(function () {
  ...
  function instanceStore(key) {
    ...
    return function get(el, factory) {
      if (!el) return null;
      var bag = el.__bs_shim || (el.__bs_shim = {});
  ...
  Tooltip.prototype._render = function () {
    ...
    tip.className = "bs-tooltip bs-tooltip-" + this._placement;
