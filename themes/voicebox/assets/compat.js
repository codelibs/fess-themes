...
/*
 * VoiceBox theme — Bootstrap JavaScript compatibility shim.
 *
 * The VoiceBox theme ships no Bootstrap/Popper. The SPA modules (app.js,
...
(function () {
  ...
  Tooltip.prototype._render = function () {
    ...
    tip.className = "vb-tooltip vb-tooltip-" + this._placement;
