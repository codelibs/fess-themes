...
Either download a published ZIP, or package one from this repository — packaging from a
checkout always works, whether or not anything has been published yet.
...
bump. A change without a bump is never distributed — see [`CLAUDE.md`](CLAUDE.md).
