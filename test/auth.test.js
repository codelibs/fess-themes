...
vi.mock("../themes/docuforge/assets/api.js", () => ({
  get: vi.fn(),
  post: vi.fn(),
  getConfig: vi.fn(),
...
} from "../themes/docuforge/assets/auth.js";
...
describe("localizePasswordError (positional substitution)", () => {
  it("substitutes min_length into the localized password-length message", async () => {
    ...
    const i18n = await import("../themes/docuforge/assets/i18n.js");
    ...
    await i18n.init();
    const freshAuth = await import("../themes/docuforge/assets/auth.js");
