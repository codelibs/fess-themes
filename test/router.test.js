...
// Ported from the bootstrap theme in the fess repository. router.js is byte-identical in
// every theme (parity.test.js), so the behaviour is tested once, on docuforge's copy:
// attach() adds document-level listeners that would interfere across ten copies.

import { describe, it, expect, beforeAll, beforeEach, afterEach, vi } from "vitest";
import { resetDom as resetBody, setLocation } from "./helpers/dom.js";

const ROUTER = "../themes/docuforge/assets/router.js";

/** Empty <body> and <head> (a test may have added <base href>). */
function resetDom() {
  resetBody();
