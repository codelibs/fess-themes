...
// Ported from the bootstrap theme in the fess repository. auth.js and profile.js are
// byte-identical in every theme (parity.test.js), so the behaviour is tested once, on
// docuforge's copy.
...
vi.mock("../themes/docuforge/assets/api.js", () => ({ post: vi.fn() }));
vi.mock("../themes/docuforge/assets/router.js", () => ({ navigate: vi.fn() }));
vi.mock("../themes/docuforge/assets/auth.js", async (importOriginal) => ({
...
import * as router from "../themes/docuforge/assets/router.js";
import * as auth from "../themes/docuforge/assets/auth.js";
import { attach } from "../themes/docuforge/assets/profile.js";
